 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kd="storage";function xE(t,e,n){return t=U(t),yE(t,e,n)}function UE(t,e,n){return t=U(t),vE(t,e,n)}function FE(t){return t=U(t),_E(t)}function VE(t){return t=U(t),wE(t)}function BE(t,e){return t=U(t),SE(t,e)}function $E(t=ro(),e){t=U(t);const s=lr(t,kd).getImmediate({identifier:e}),r=nu("storage");return r&&AE(s,...r),s}function AE(t,e,n,s={}){bE(t,e,n,s)}function CE(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new Ta(n,s,r,e,Pt)}function kE(){bt(new ct(kd,CE,"PUBLIC").setMultipleInstances(!0)),Oe(Xc,Yc,""),Oe(Xc,Yc,"esm2017")}kE();export{aw as A,rw as B,ct as C,Y_ as D,J_ as E,Fe as F,tt as G,Z_ as H,uw as I,ew as J,lw as K,UE as L,RE as M,LE as N,q_ as P,dw as Q,X_ as R,fw as W,lr as _,xu as a,Xp as b,PE as c,OE as d,Wh as e,sw as f,ME as g,hw as h,ow as i,ro as j,U as k,nu as l,iw as m,bt as n,DE as o,Qf as p,$E as q,Oe as r,NE as s,W as t,BE as u,xE as v,FE as w,VE as x,cw as y,B_ as z};
